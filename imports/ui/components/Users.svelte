            ...
            {#if users[0]}
                {#each users as user}
                    <div class="flex items-center justify-center">
                        <div class="flex-1 h-7 overflow-hidden border-l border-y border-solid border-zinc-400">
                            <span>{user.username}</span>
                        </div>
                        <div class="flex-2 h-7 overflow-hidden border-x border-y border-solid border-zinc-400">
