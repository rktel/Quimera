...
<!-- DRAWER -->
{#if bDrawer}
    <div class="dark:bg-dark-800 bg-white h-[calc(100vh_-_32px)] shadow-lg absolute top-8 z-30 w-[340px] grid grid-rows-[32px,1fr]">
        <div class="flex justify-end px-3 items-center"> 
            <button class="h-5 w-5 shadow rounded-full text-white text-xs hover:ring" on:click={_=> bDrawer = false}>
        ...
        <div class="grid grid-rows-[60px,60px,60px,60px,40px] gap-4 p-5">
            <div class="grid grid-rows-[20px,30px] gap-2">
                ...
                <input bind:value="{firstname}" type="text" name="firstname" class="ring-1 ring-dark-300 rounded px-3 dark:text-dark-800 focus:outline-none focus:ring-alfa-500" required>
            </div>
            <div class="grid grid-rows-[20px,30px] gap-2">
                <label for="lastname" class="text-dark-700 dark:text-dark-200 text-xs">Apellido</label>
                <input bind:value="{lastname}" type="text" name="lastname" class="ring-1 ring-dark-300 rounded px-3 dark:text-dark-800 focus:outline-none focus:ring-alfa-500" required>
            </div>
            <div class="grid grid-rows-[20px,30px] gap-2">
                <label for="_username" class="text-dark-700 dark:text-dark-200 text-xs">Nombre de usuario</label>
                <input bind:value="{username}" type="text" name="_username" class="ring-1 ring-dark-300 rounded px-3 dark:text-dark-800 focus:outline-none focus:ring-alfa-500" required>
            </div>
            <div class="grid grid-rows-[20px,30px] gap-2">
                <label for="_password" class="text-dark-700 dark:text-dark-200 text-xs">Contraseña</label>
                <input bind:value="{password}" type="text" name="_password" class="ring-1 ring-dark-300 rounded px-3 dark:text-dark-800 focus:outline-none focus:ring-alfa-500" required>
            </div>
            <div class="">
