<script>
    ...
    const styles = {
        active: "bg-dark-100 text-alfa-500 border border-b-0 border-alfa-500"
    }

 
</script>

<div class="h-9 text-sm font-normal bg-dark-50 text-dark-800 grid grid-cols-[120px,120px,120px,1fr,200px]">
