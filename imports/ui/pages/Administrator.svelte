...
<div class="h-8 text-sm font-normal bg-white text-dark-500 grid grid-cols-[120px,120px,120px,1fr,auto]">
    ...
    <div class="rounded-2xl bg-dark-200 ml-4"></div>
    ...
    <div class="bg-white flex justify-end items-center gap-4 px-4">
           ...
           {#if bUserOptions}
             <div class="absolute rounded-sm top-8 right-4 shadow grid gap-3 p-3 z-20 text-xs font-medium">
                ...
                <button class="text-dark-600 flex justify-between" use:clickOutside on:click_outside={_ => bUserOptions = false} on:click={fLogout}>
