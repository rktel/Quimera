...
<div class="h-screen grid grid-rows-[40px,1fr]">
    ...
    <div class="grid grid-cols-[auto,1fr,auto] bg-dark-50 dark:bg-dark-700 border-b border-beta-500">
        ...
        <div class="flex items-center px-5">
            <button class="h-[23px] w-[23px] text-white text-sm font-bold shadow hover:ring-beta-300 hover:ring-1 bg-beta-700 rounded-full">{user&&user.profile?user.profile.firstname.charAt(0):''}</button>
        </div>
        <!-- OPTION USER_END -->
    </div>
    <!-- BAR_END -->
